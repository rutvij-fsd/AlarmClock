...
setalarmbutton.addEventListener("click", function () {
  ...
  div.id =
    ...
    ":" +
    document.getElementById("ampmss").value;
...
setInterval(function () {
  ...
  for (
    let i = 0;
    i < document.getElementsByClassName("alarmtime").length;
    i++
  ) {
    if (
      hr + ":" + min + ":" + sec + " " + ampms.innerText ==
      document.getElementsByClassName("alarmtime")[i].innerText
    ) {
      ringBell();
